...
export default function AddPropertyForm({ pt, pb }) {
    ...
    const handleFile = file => { //you can carry out any file validations here... 
        setPreviewUrl(URL.createObjectURL(file));
    };
    const handleDragOver = e => {
        e.preventDefault();
        e.stopPropagation(); // setPreviewUrl(URL.createObjectURL(imageFile)); }; 
        const handleDrop = e => {
            e.preventDefault();
            e.stopPropagation();
        ...
        const onSubmitHandler = event => {
            ...
            if (!fileInput.current.files.length < 1 || !previewUrl === "" || !previewUrl === undefined) {
            ...
            axios.post("http://localhost:1055/api/properties", formData, config).then(response => {
       ...
       <div  className = "theme_container">
          <div style= {{
                ...
                <h2> 
                    Add Properties></h2>
              <h1>Add Properties details</h1><p>Take the next step to owning more property than you ever thought possible in your current stage of life. We're excited to help you build prosperity and share the wealth. We're here to support you all the way to make it happen.
                </p><div
                    className="get_started_inputs"><form
