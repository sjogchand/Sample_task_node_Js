            ...
            <Tab
              icon={
                <div class="Button___content__MtnK9">
                  ...
                  <span class="text-white whitespace-no-wrap type-body Button_button__label__vnXgq Button_icon-button__label__HdHBw">
                    Photos
                  </span>
                </div>
              }
        ...
        <iframe
          src={
            props.propertyDetails.video_url !== null
              ? `http://localhost:1055/${props.propertyDetails.video_url}`
              : video
          }
          style={{
            width: '900px',
