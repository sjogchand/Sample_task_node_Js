                ...
                <div className='get_started_inputs'>
                    ...
                    <form action="">
                            ...
                            <div className='main_dropdown_payment'>
                                ...
                                <div className='dropdown_payment'>
                                    <span className="sub_dd">
                                        <input className="" ref={accessRef} onBlur={onBlurHandler.bind(this, accessRef)} type="radio" defaultChecked name="category" id="one-time" value='one-time' required />
                                    ...
                                    <span className="sub_dd">
                                        <input
                                            className="" ref={accessRef} onBlur={onBlurHandler.bind(this, accessRef)} type="radio" name="category" id="9month" value='9month' required />
                        ...
                        <div className='get_started_checkbox_row'>
                            <input ref={permissionRef} onBlur={onBlurHandler.bind(this, permissionRef)} type="checkbox" name="permission" defaultChecked readOnly required id="checkbox" /> <label>I give Milenium Haus permission to contact me & agree to the <a href="">Term and Conditions.</a></label>
                        </div>
