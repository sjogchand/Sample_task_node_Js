...
const ImageSlider = ({ slides, sliderData }) => {
  ...
  return (
    <section className="slider">
      ...
      <div class="PropertyImageCarousel_index-indicator-mediahub__mlO8x navigation">
        <button
          aria-label="Previous Image"
          class="Button_button__2JA4L Button_icon-button__92EF8 Button_icon-button--white__1MAfl"
        ...
        <div class="type-body-sm flex items-center">
          <span>{current+1}</span>
          <span>/</span>
          <span>{length}</span>
        </div>
